...
// Auth information
global.pairNumber = "27847826044";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["27847826044", "27847826044"];
...
global.OwnerName = process.env.OWNER_NAME || "CraigeeX";
global.BotName = process.env.BOT_NAME || "X Tech Hub";
global.packname = process.env.PACK_NAME || "X Tech Hub";
